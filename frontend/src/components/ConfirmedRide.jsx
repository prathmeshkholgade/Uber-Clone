...
export default function ConfirmedRide({
  setVehicleFound,
  ...
  return (
    <div>
      ...
      <h3 className="text-2xl font-semibold mb-2">Conform Your Ride a</h3>
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <button
          ...
          className="mt-5 w-full bg-green-600 text-white p-2 font-semibold rounded-lg"
        >
          Confirm
        </button>
      </div>
